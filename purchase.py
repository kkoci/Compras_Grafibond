...
class purchase_order(osv.osv):
    ...
    _track = {
        'state': {
            ...
            #'purchase.mt_rfq_certificado': lambda self, cr, uid, obj, ctx=None: obj['state'] == 'certificado',
        },
    }
    ...
    _columns = {
        ...
        'provee' : fields.char('Proveedor'),
        'soli_cant' : fields.char('Cantidad de Solicitudes'),
        'dest' : fields.char('Destino'),
        'anho' : fields.char('Año'),
        'nombre' : fields.function(_combinalos, type='char', string='Nombre', arg=('company_id','partner_id','soli_cant', 'dest', 'date_order'), method=True),
        ...
        'sol_cad' : fields.integer('Solicitud CADIVI'),
        'naad' : fields.integer('N° AAD'),
        'vaad' : fields.date('Validez AAD', select=True),
        'sllegada' : fields.char('Status Llegada', size=128),
        'falmacen' : fields.date('Fecha Almacen', select=True),
        'pedeacta' : fields.date('Posible Entrega de Acta', select=True),
        'nfactu' : fields.char('N° Factura', size=128),
        'mfactu' : fields.float('Monto Factura'),
        'sliqui' : fields.char('Status Liquidación', size=128),
        'mald' : fields.float('Monto ALD'),
        'nald' : fields.integer('N° ALD'),
        'vald' : fields.char('Validez ALD', size=128),
        'cbcv' : fields.date('Cierre BCV', select=True),
        'num_pro' : fields.char('Numero Proforma'),
        'mon_pro' : fields.char('Monto Proforma'),
        'num_req' : fields.char('Numero Requisicion'),
        'num_codigo' : fields.char('Numero Código'),
        'prioritaire' : fields.selection([('urgente','Urgente'),('normal','Normal'),('baja', 'Baja')], 'Prioridad'),
        'requ_date' : fields.datetime('Fecha Requisicion'),
    ...
    # def wkf_origen_certificado(self, cr, uid, ids, context=None):
        # self.write(cr, uid, ids, {'state': 'certificado', 'date_approve': fields.date.context_today(self,cr,uid,context=context)})
        # return True
...
class purchase_order_line(osv.osv):
    ...
    _columns = {
        ...
        'canti_cert' : fields.related('product_id', 'canti_cert', type='float', string='Cantidad Certificado'),
        ...
        'nrparte' : fields.integer('Nro. de Parte'),    
        #'cert_v' : fields.boolean('¿Origen Certificado?'),
