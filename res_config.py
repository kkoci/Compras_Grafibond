...
Example: Product: this product is deprecated, do not purchase more than 5.
        ...
        'module_compras_validacion_doble': fields.boolean("Force two levels of approvals",
            help="""Provide a double validation mechanism for purchases exceeding minimum amount.
                This installs the module purchase_double_validation."""),
        'module_requisicion_grafibond_2': fields.boolean("Manage purchase requisitions",
        ...
        'module_planes_analiticos_compra': fields.boolean('Use multiple analytic accounts on purchase orders',
        ...
        'group_analitico_account_for_purchases': fields.boolean('Analytic accounting for purchases',
            implied_group='compra_grafibond.group_analytic_accounting',
...
class account_config_settings(osv.osv_memory):
    ...
    _columns = {
        'module_planes_analiticos_compra': fields.boolean('Use multiple analytic accounts on orders',
            help ="""Allows the user to maintain several analysis plans. These let you split lines on a purchase order between several accounts and analytic plans.
                This installs the module purchase_analytic_plans."""),
        'group_analitico_account_for_purchases': fields.boolean('Analytic accounting for purchases',
            implied_group='compra_grafibond.group_analytic_accounting',
    ...
    def onchange_purchase_analytic_plans(self, cr, uid, ids, module_planes_analiticos_compra, context=None):
        """ change group_analitico_account_for_purchases following module_planes_analiticos_compra """
        return {'value': {'group_analitico_account_for_purchases': module_planes_analiticos_compra}}
